...
Use for local edits to an approved CEO Boss image. Prefer one concrete change per edit.

```text
In image 1, edit CEO Boss, the stern stylized chibi corporate executive mascot.

Preserve the exact character identity, facial structure, warm peach skin tone, narrow dark stern eyes, thick angled black eyebrows, glossy black side-parted swept-back hair silhouette, compact chibi body proportions, black suit, white shirt, red tie, black shoes, and glossy 3D toy-like illustration style.

Change only:
- [single requested local edit]
