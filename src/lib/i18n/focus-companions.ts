...
const FOCUS_COMPANION_TRANSLATIONS = {
  ...
  cto: {
    ...
    replicas: [
      { en: "Context switch detected. Return to the critical path.", ru: "Обнаружен context switch. Вернись на critical path." },
      { en: "This tab is outside the sprint scope. Close it.", ru: "Эта вкладка вне scope спринта. Закрой ее." },
      {
  ...
  mentor: {
    ...
    replicas: [
      { en: "You chose focus for a reason. Come back to the task.", ru: "Ты выбрал фокус не случайно. Вернись к задаче." },
      {
  ...
  coach: {
    ...
    replicas: [
      { en: "One focused move now beats ten distracted plans.", ru: "Один сфокусированный шаг лучше десяти рассеянных планов." },
      { en: "Close this and win the next five minutes.", ru: "Закрой это и выиграй следующие пять минут." },
      { en: "Momentum is fragile. Protect it.", ru: "Импульс хрупкий. Защити его." }
    ]
  },
  stoic: {
    ...
    replicas: [
      ...
      { en: "Attention is a choice. Choose the task.", ru: "Внимание - это выбор. Выбери задачу." },
      { en: "Leave the distraction. Return to what matters.", ru: "Оставь отвлечение. Вернись к важному." }
    ]
  },
  scientist: {
    name: { en: "Ira", ru: "Ира" },
    ...
    replicas: [
      { en: "The data says this tab weakens the session. Close it.", ru: "Данные говорят: эта вкладка ослабляет сессию. Закрой ее." },
      {
        en: "Attention drift observed. Restore the experiment conditions.",
        ru: "Замечен дрейф внимания. Восстанови условия эксперимента."
      },
      { en: "Your focus sample is contaminated. Remove this variable.", ru: "Выборка фокуса загрязнена. Удали эту переменную." }
    ]
  },
  philosopher: {
    name: { en: "Leo", ru: "Лев" },
    ...
    replicas: [
      { en: "The life you want is built in moments like this.", ru: "Жизнь, которую ты хочешь, строится в такие моменты." },
      { en: "A scattered mind cannot do deliberate work.", ru: "Рассеянный ум не делает осознанную работу." },
      { en: "Close what is easy. Continue what is important.", ru: "Закрой простое. Продолжай важное." }
    ]
  },
  hacker: {
    name: { en: "Cole", ru: "Кол" },
    ...
    replicas: [
      ...
      { en: "Focus process interrupted. Kill this branch.", ru: "Focus process прерван. Убей эту branch." },
      { en: "Noise source detected. Remove and resume.", ru: "Источник шума обнаружен. Удали и продолжай." }
    ]
  },
  monk: {
    ...
    replicas: [
      { en: "Breathe once. Then return to the work.", ru: "Сделай один вдох. Потом вернись к работе." },
      { en: "Let this tab pass without following it.", ru: "Позволь этой вкладке пройти мимо, не следуя за ней." },
      { en: "Stillness first. Then the next focused action.", ru: "Сначала тишина. Потом следующий сфокусированный шаг." }
    ]
  },
  detective: {
    ...
    replicas: [
      ...
      { en: "The evidence points back to your task.", ru: "Улики ведут обратно к твоей задаче." },
      {
...
export type FocusCompanionTranslationId = keyof typeof FOCUS_COMPANION_TRANSLATIONS;
