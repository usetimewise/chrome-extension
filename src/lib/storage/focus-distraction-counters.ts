...
function normalizeCountersState(value: FocusDistractionCountersState | null): FocusDistractionCountersState {
  ...
  return {
    ...
    lastDistractedAt: isFiniteNumber(value.lastDistractedAt) ? value.lastDistractedAt : null,
...
export async function getFocusDistractionCounters(): Promise<FocusDistractionCountersState> {
  return normalizeCountersState(
    await getFromStorage<FocusDistractionCountersState | null>(STORAGE_KEYS.focusDistractionCounters, null)
  );
}
...
export async function saveFocusDistractionCounters(
  ...
  return setInStorage(STORAGE_KEYS.focusDistractionCounters, normalizeCountersState(state));
}
...
export async function resetFocusDistractionCounters(
  ...
  return saveFocusDistractionCounters(createEmptyFocusDistractionCounters(sessionId, now));
}
