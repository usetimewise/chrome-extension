...
import type { Category, Settings, SiteRuleState, UserPreferences } from "../types.js";
...
export async function getUserPreferences(): Promise<UserPreferences> {
  const preferences = await getFromStorage<Partial<UserPreferences> | null>(STORAGE_KEYS.preferences, null);
...
export function buildEffectiveSettings(
  ...
  const blockedCategoryOverrides: Record<string, Category> = Object.fromEntries(
